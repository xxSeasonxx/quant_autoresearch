# Historical Snapshot: Harness Objective Redesign Roadmap

This file preserves the original roadmap text from before the money-first
objective branch was completed. It is historical material only. The active
process roadmap is `docs/harness-objective-roadmap.md`; the active score
contract is `docs/score_research.md`.
